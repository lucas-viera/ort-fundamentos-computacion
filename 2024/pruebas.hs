...
p62 = valido cobls
p63 = valido (C "X" [])                                                      --pasa
p64 = valido (C "X" [ A ("a",Mp3), A ("a",Mp3) ]) == False                   --pasa
p65 = valido (C "X" [ C "D" [], C "D" []]) == False                          --pasa

p66 = valido (C "X" [ A ("a",Hs), A ("a",Mp3) ])

p67 = valido (C "X" [ C "R" [A ("a",Mp3), A ("a",Mp3)], C "S" []]) == False  --pasa
p68 = valido (C "X" [ C "R" [C "D" [], C "D" []], C "S" []]) == False        --pasa
